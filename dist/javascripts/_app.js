...
/***/ function(module, exports, __webpack_require__) {
	...
	Bumpin = (function() {
	  ...
	  Bumpin.prototype.update = function() {
	    ...
	    if (this.time === current_time && this.isPlaying()) {
	      if (this.loop) {
	        this.play();
	      }
	    }
	  ...
	  Bumpin.prototype.onKick = function(a) {
	    ...
	    return (function(_this) {
	      return function() {
	        var $elm, anim, anim_data, color, current_freq, kick, other_opts, range, ref, scale;
	  ...
	  Bumpin.prototype.getRandomColor = function() {
